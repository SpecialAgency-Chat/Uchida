...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24 text-lg">
      ...
      <p className="px-3 py-2 rounded-full bg-emerald-500 hover:bg-emerald-600" role="button"><a href={`https://discord.com/api/oauth2/authorize?client_id=${process.env.NEXT_PUBLIC_CLIENT_ID}&redirect_uri=${encodeURIComponent(process.env.NEXT_PUBLIC_REQUEST_REDIRECT_URI)}&response_type=code&scope=identify%20guilds.join%20role_connections.write&prompt=none`}>Join Request</a></p>
    </main>
  );
}
